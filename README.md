...
> Regenerate this table from config (so it always matches reality, not memory):
> `node tools/c-thru-explain.js --all --mode best-cloud --tier 64gb --format json`

| Agent | Capability | `best-cloud` | `best-cloud-oss` | `best-local-oss` | Endpoint (`best-cloud`) |
|---|---|---|---|---|---|
| `code-reviewer` | `code-reviewer` | `claude-sonnet-4-6` | `qwen3.6:35b` | `qwen3.6:35b` | `anthropic` |
| `coder` | `coder` | `gemini-pro` | `qwen3.6:35b-a3b-coding-nvfp4` | `qwen3.6:35b-a3b-coding-nvfp4` | `gemini_ai` |
| `coder-fallback` | `coder-fallback` | `gemini-pro-latest` | `deepseek-v4-flash:cloud` | `qwen3-coder-next:latest` | `gemini_ai` |
| `debugger-hard` | `debugger-hard` | `claude-opus-4-8` | `deepseek-v4-flash:cloud` | `qwen3.6:35b` | `anthropic` |
| `debugger-hypothesis` | `debugger-hypothesis` | `gemini-pro` | `qwen3.6:35b` | `qwen3.6:35b` | `gemini_ai` |
| `debugger-investigate` | `debugger-investigate` | `gemini-pro` | `qwen3.6:35b-a3b-coding-nvfp4` | `qwen3.6:35b-a3b-coding-nvfp4` | `gemini_ai` |
...
| `generalist` | `generalist` | `claude-sonnet-4-6` | `qwen3.6:35b` | `qwen3.6:35b` | `anthropic` |
...
| `planner` | `planner` | `claude-sonnet-4-6` | `qwen3.6:35b` | `qwen3.6:35b` | `anthropic` |
| `planner-hard` | `planner-hard` | `claude-opus-4-8` | `deepseek-v4-flash:cloud` | `qwen3.6:35b` | `anthropic` |
| `reviewer-plan` &nbsp;⚠ | `code-reviewer` | `claude-sonnet-4-6` | `qwen3.6:35b` | `qwen3.6:35b` | `anthropic` |
| `reviewer-security` | `reviewer-security` | `claude-opus-4-8` | `deepseek-v4-flash:cloud` | `qwen3.6:35b` | `anthropic` |
...
| `writer` | `writer` | `claude-sonnet-4-6` | `deepseek-v4-pro:cloud` | `qwen3.6:35b` | `anthropic` |
