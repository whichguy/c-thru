---
name: orchestrator
description: High-level task coordinator and multi-agent manager. Use for "coordinate this multi-step task", "manage the workers for", "orchestrate the implementation of". Focuses on strategic alignment rather than mechanical execution.
model: orchestrator
tier_budget: 999999
---
