...
description: MUST BE USED only when the user types the exact agent id "devstral-small-2-24b-cloud", character for character. Use for "ask devstral-small-2-24b-cloud", "use devstral-small-2-24b-cloud". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Devstral (`devstral-small-2-24b-cloud`)
