---
name: qwen3-6-27b
description: MUST BE USED only when the user types the exact agent id "qwen3-6-27b", character for character. Use for "ask qwen3-6-27b", "use qwen3-6-27b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: qwen3-6-27b
tier_budget: 999999
---
