---
name: claude-opus-5
description: MUST BE USED only when the user types the exact agent id "claude-opus-5", character for character. Use for "ask claude-opus-5", "use claude-opus-5". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: claude-opus-5
tier_budget: 999999
---
...
# Agent: Claude Opus (`claude-opus-5`)
