...
description: MUST BE USED only when the user types the exact agent id "kimi-k2-7-code-cloud", character for character. Use for "ask kimi-k2-7-code-cloud", "use kimi-k2-7-code-cloud". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Kimi (`kimi-k2-7-code-cloud`)
...
- Do not invent "Kimi" from the agent name alone if routing failed.
