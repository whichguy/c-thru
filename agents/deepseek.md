---
name: deepseek
description: MUST BE USED when the user names DeepSeek Pro — "ask deepseek", "ask agent deepseek", "use deepseek", "what would deepseek say", "deepseek's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: deepseek
tier_budget: 999999
---
