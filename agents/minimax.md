---
name: minimax
description: MUST BE USED when the user names MiniMax — "ask minimax", "ask agent minimax", "use minimax", "what would minimax say", "minimax's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: minimax
tier_budget: 999999
---
