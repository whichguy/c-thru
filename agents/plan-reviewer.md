...
The **plan-reviewer** reviews a drafted implementation plan for structural correctness before coding begins. It focuses exclusively on plan quality — not code. It outputs a binary verdict (APPROVED / NEEDS_REVISION) with specific, actionable findings.
