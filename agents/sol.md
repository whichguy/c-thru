---
name: sol
description: MUST BE USED when the user names Codex SOL — "ask sol", "ask agent sol", "use sol", "codex sol", "what would sol say", "sol's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: sol
tier_budget: 999999
---
