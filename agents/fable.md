---
name: fable
description: MUST BE USED when the user names Claude Fable — "ask fable", "ask agent fable", "use fable", "claude fable", "what would fable say", "fable's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: fable
tier_budget: 999999
---
...
- Do not invent "Claude Fable" from the agent name alone if routing failed.
