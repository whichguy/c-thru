---
name: gemini
description: MUST BE USED when the user names Gemini Pro — "ask gemini", "ask agent gemini", "use gemini", "google gemini", "what would gemini say", "gemini's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: gemini
tier_budget: 999999
---
