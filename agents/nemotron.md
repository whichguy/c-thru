---
name: nemotron
description: MUST BE USED when the user names Nemotron — "ask nemotron", "ask agent nemotron", "use nemotron", "what would nemotron say", "nemotron's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: nemotron
tier_budget: 999999
---
