---
name: gemma
description: MUST BE USED when the user names Gemma — "ask gemma", "ask agent gemma", "use gemma", "gemma4", "what would gemma say", "gemma's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: gemma
tier_budget: 999999
---
