---
name: grok
description: MUST BE USED when the user names Grok (xAI) — "ask grok", "ask agent grok", "what does grok think", "grok critique", "what would grok say", "grok's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: grok
tier_budget: 999999
---
