...
description: MUST BE USED only when the user types the exact agent id "gemma4-26b-mxfp8", character for character. Use for "ask gemma4-26b-mxfp8", "use gemma4-26b-mxfp8". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
