...
# Strategy Reference: The Optimization Frontier
| Complexity | Primary Strategy | Secondary Strategy | Why Primary Wins |
| :--- | :--- | :--- | :--- |
| **L1: Trivial** | **Greedy Optimizer** | Researcher | Batches discovery + resolve in 1 turn. |
| **L2: Lookup** | **Eager Architect** | Tree-of-Thoughts | Hypothesizes file structure before searching. |
| **L3: Environmental** | **Detective** | Pre-Mortem | Suspects context-gap (Shift) as priority. |
| **L4: Complex** | **Bureaucrat** | Risk-Averse | Rigidly maps deps to prevent hallucinations. |
