---
name: devstral-2
description: MUST BE USED only when the user types the exact agent id "devstral-2", character for character. Use for "ask devstral-2", "use devstral-2". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: devstral-2
tier_budget: 999999
---
