---
name: qwen3-6-35b-a3b-q8-0
description: MUST BE USED only when the user types the exact agent id "qwen3-6-35b-a3b-q8-0", character for character. Use for "ask qwen3-6-35b-a3b-q8-0", "use qwen3-6-35b-a3b-q8-0". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: qwen3-6-35b-a3b-q8-0
tier_budget: 999999
---

<!-- GENERATED by tools/gen-brand-agents.js; edits will be overwritten. -->

# Agent: Qwen (`qwen3-6-35b-a3b-q8-0`)
