---
name: phi4-mini-3-8b
description: MUST BE USED only when the user types the exact agent id "phi4-mini-3-8b", character for character. Use for "ask phi4-mini-3-8b", "use phi4-mini-3-8b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
