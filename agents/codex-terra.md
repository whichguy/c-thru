---
name: codex-terra
description: MUST BE USED only when the user types the exact agent id "codex-terra", character for character. Use for "ask codex-terra", "use codex-terra". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: codex-terra
tier_budget: 999999
---
...
- Do not invent "Codex Terra" from the agent name alone if routing failed.
