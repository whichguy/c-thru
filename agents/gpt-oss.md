---
name: gpt-oss
description: MUST BE USED when the user names GPT-OSS — "ask gpt-oss", "ask agent gpt-oss", "use gpt-oss", "gpt oss", "what would gpt-oss say", "gpt-oss's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: gpt-oss
tier_budget: 999999
---
