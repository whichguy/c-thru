---
name: glm-5-2-cloud
description: MUST BE USED only when the user types the exact agent id "glm-5-2-cloud", character for character. Use for "ask glm-5-2-cloud", "use glm-5-2-cloud". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: glm-5-2-cloud
tier_budget: 999999
---
