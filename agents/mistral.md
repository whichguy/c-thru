---
name: mistral
description: MUST BE USED when the user names Mistral Small — "ask mistral", "ask agent mistral", "use mistral", "mistral small", "what would mistral say", "mistral's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: mistral
tier_budget: 999999
---
