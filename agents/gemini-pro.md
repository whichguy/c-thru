---
name: gemini-pro
description: MUST BE USED only when the user types the exact agent id "gemini-pro", character for character. Use for "ask gemini-pro", "use gemini-pro". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: gemini-pro
tier_budget: 999999
---
