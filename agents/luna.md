---
name: luna
description: MUST BE USED when the user names Codex Luna — "ask luna", "ask agent luna", "use luna", "codex luna", "what would luna say", "luna's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: luna
tier_budget: 999999
---
