---
name: qwen
description: MUST BE USED when the user names Qwen — "ask qwen", "ask agent qwen", "use qwen", "local qwen", "what would qwen say", "qwen's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: qwen
tier_budget: 999999
---
