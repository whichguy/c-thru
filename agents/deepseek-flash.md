---
name: deepseek-flash
description: MUST BE USED when the user names DeepSeek Flash — "ask deepseek flash", "deepseek-v4-flash", "use deepseek flash", "what would deepseek-flash say", "deepseek-flash's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
...
# Agent: DeepSeek Flash (`deepseek-flash`)
