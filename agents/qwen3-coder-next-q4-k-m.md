---
name: qwen3-coder-next-q4-k-m
description: MUST BE USED only when the user types the exact agent id "qwen3-coder-next-q4-k-m", character for character. Use for "ask qwen3-coder-next-q4-k-m", "use qwen3-coder-next-q4-k-m". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Qwen (`qwen3-coder-next-q4-k-m`)
