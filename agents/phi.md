---
name: phi
description: MUST BE USED when the user names Phi — "ask phi", "ask agent phi", "use phi", "phi4", "what would phi say", "phi's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: phi
tier_budget: 999999
---
