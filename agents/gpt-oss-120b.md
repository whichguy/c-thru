---
name: gpt-oss-120b
description: MUST BE USED only when the user types the exact agent id "gpt-oss-120b", character for character. Use for "ask gpt-oss-120b", "use gpt-oss-120b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: gpt-oss-120b
tier_budget: 999999
---
