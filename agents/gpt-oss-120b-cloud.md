...
description: MUST BE USED only when the user types the exact agent id "gpt-oss-120b-cloud", character for character. Use for "ask gpt-oss-120b-cloud", "use gpt-oss-120b-cloud". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: GPT-OSS (`gpt-oss-120b-cloud`)
