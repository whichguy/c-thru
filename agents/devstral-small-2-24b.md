...
description: MUST BE USED only when the user types the exact agent id "devstral-small-2-24b", character for character. Use for "ask devstral-small-2-24b", "use devstral-small-2-24b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Devstral (`devstral-small-2-24b`)
