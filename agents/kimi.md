---
name: kimi
description: MUST BE USED when the user names Kimi — "ask kimi", "ask agent kimi", "use kimi", "moonshot kimi", "what would kimi say", "kimi's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: kimi
tier_budget: 999999
---
