---
name: devstral
description: MUST BE USED when the user names Devstral — "ask devstral", "ask agent devstral", "use devstral", "mistral devstral", "what would devstral say", "devstral's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: devstral
tier_budget: 999999
---
