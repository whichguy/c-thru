...
description: MUST BE USED only when the user types the exact agent id "gemini-3-flash-preview-cloud", character for character. Use for "ask gemini-3-flash-preview-cloud", "use gemini-3-flash-preview-cloud". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Gemini Flash (`gemini-3-flash-preview-cloud`)
