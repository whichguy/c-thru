---
name: qwen3-4b
description: MUST BE USED only when the user types the exact agent id "qwen3-4b", character for character. Use for "ask qwen3-4b", "use qwen3-4b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: qwen3-4b
tier_budget: 999999
---
