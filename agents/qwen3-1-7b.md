---
name: qwen3-1-7b
description: MUST BE USED only when the user types the exact agent id "qwen3-1-7b", character for character. Use for "ask qwen3-1-7b", "use qwen3-1-7b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: qwen3-1-7b
tier_budget: 999999
---
