---
name: qwen3-vl-8b
description: MUST BE USED only when the user types the exact agent id "qwen3-vl-8b", character for character. Use for "ask qwen3-vl-8b", "use qwen3-vl-8b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: qwen3-vl-8b
tier_budget: 999999
---
