...
description: MUST BE USED only when the user types the exact agent id "qwen3-6-27b-coding-mxfp8", character for character. Use for "ask qwen3-6-27b-coding-mxfp8", "use qwen3-6-27b-coding-mxfp8". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Qwen (`qwen3-6-27b-coding-mxfp8`)
