---
name: gpt-5-6-sol
description: MUST BE USED only when the user types the exact agent id "gpt-5-6-sol", character for character. Use for "ask gpt-5-6-sol", "use gpt-5-6-sol". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: gpt-5-6-sol
tier_budget: 999999
---
