...
description: MUST BE USED only when the user types the exact agent id "qwen3-6-35b-a3b-coding-nvfp4", character for character. Use for "ask qwen3-6-35b-a3b-coding-nvfp4", "use qwen3-6-35b-a3b-coding-nvfp4". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
...
# Agent: Qwen (`qwen3-6-35b-a3b-coding-nvfp4`)
