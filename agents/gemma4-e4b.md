---
name: gemma4-e4b
description: MUST BE USED only when the user types the exact agent id "gemma4-e4b", character for character. Use for "ask gemma4-e4b", "use gemma4-e4b". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: gemma4-e4b
tier_budget: 999999
---
