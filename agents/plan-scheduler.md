---
name: plan-scheduler
description: Use to dispatch a wave of READY_ITEMS from a c-thru plan to worker agents via TaskCreate. Thin wrapper around the /schedule-plan-tasks skill. Use after planner produces READY_ITEMS and before wave execution begins. Routes to fast-generalist (terminal dispatch step).
