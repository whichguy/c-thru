---
name: haiku
description: MUST BE USED when the user names Claude Haiku — "ask haiku", "ask agent haiku", "use haiku", "claude haiku", "what would haiku say", "haiku's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: haiku
tier_budget: 999999
---
