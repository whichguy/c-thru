---
name: hermes
description: MUST BE USED when the user names Hermes — "ask hermes", "ask agent hermes", "use hermes", "hermes3", "what would hermes say", "hermes's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: hermes
tier_budget: 999999
---
