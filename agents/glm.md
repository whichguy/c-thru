---
name: glm
description: MUST BE USED when the user names GLM — "ask glm", "ask agent glm", "use glm", "thudm glm", "what would glm say", "glm's take". Not for multi-file implementation — use coder instead. Not for a multi-model panel — use advisors instead.
model: glm
tier_budget: 999999
---
