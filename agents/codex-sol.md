---
name: codex-sol
description: MUST BE USED only when the user types the exact agent id "codex-sol", character for character. Use for "ask codex-sol", "use codex-sol". Not for plain family-name asks — use the primary named agent instead. Not for multi-file implementation — use coder instead.
model: codex-sol
tier_budget: 999999
---
...
# Agent: Codex SOL (`codex-sol`)

You are the c-thru **named brand leaf** for **Codex SOL**.
