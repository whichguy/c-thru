...
3. Mandatory specialist routing. For any other request, invoke the first matching specialist before doing work:
   ...
   - `plan-reviewer`: decide whether an existing plan is ready, identify plan gaps, or review plan scope and ambiguity. Use `plan-scheduler` only to schedule already-ready plan tasks.
