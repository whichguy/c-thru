...
for f in c-thru-lib.sh c-thru-ensure-proxy-on-port.sh c-thru-revive-agent-sessions.sh claude-proxy proxy-dashboard.html plan-dashboard.html plan-state-lib.js c-thru-plan-harness.js model-map-config.js model-map-resolve.js model-map-layered.js \
